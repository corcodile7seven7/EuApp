...
const navItems = [
  ...
  {
    path: '/visual', labelKey: 'nav.visual',
  ...
  {
    path: '/info', labelKey: 'nav.info',
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-56 bg-white dark:bg-dark-surface border-r border-gray-200 dark:border-dark-border min-h-[calc(100vh-3.5rem)] fixed top-14 left-0 z-20">
